...
const GridCard = ({ header, image, description, to }) => {
  return (
    <div className="flex flex-col text-sm bg-[#08090a] md:text-lg gap-2 z-20 max-w-[351px] md:max-w-[440px] md:max-h-[511px] max-h-[448px] border rounded-[20px] p-6 border-[#2525259d]">
